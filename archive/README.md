...
- `app-public.R` - Public-facing analysis workflow (manual entry, CSV upload, custom exposures)
- `app-internal.R` - Internal PHAC workflow (CEDARS Excel upload with auto-detection)
...
**Do NOT use this file for development.** All new features and bug fixes should be applied to `app-public.R` and/or `app-internal.R` in the project root.
